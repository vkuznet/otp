...
extern int erts_sys_ddll_open2(const char *path, int flags, void **handle, ErtsSysDdllError*);
#define erts_sys_ddll_open(P,F,H) erts_sys_ddll_open2(P,F,H,NULL)
extern int erts_sys_ddll_open_noext(char *path, int flags, void **handle, ErtsSysDdllError*);
